...
export default function TrackingPage() {
  ...
  useSEO({
    title: getPageTitle(`Lacak Permintaan`),
    description: `Lacak status permintaan layanan ${nomor}`,
  });
        ...
        <section className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <Typography variant="body1" color="secondary" className={styles.subtitle}>
              {error || 'Pastikan nomor permintaan yang Anda masukkan benar.'}
            </Typography>
            ...
            <div className={styles.searchCard}>
              ...
              <form
                onSubmit={(e) => {
                  ...
                  if (input.value.trim()) {
                    window.location.href = `/permintaan/${encodeURIComponent(input.value.trim())}`;
                  }
                }}
