    ...
    <PublicLayout>
      <div className={styles.container}>
        ...
        <header className={styles.pageHeader}>
          <h1 className={styles.pageTitle}>Kontak Kami</h1>
          <p className={styles.pageSubtitle}>
            Hubungi kami untuk informasi lebih lanjut tentang {villageName}
          </p>
        </header>
            ...
            <div className={styles.contactList}>
              {identitas?.telepon && (
                <div className={styles.contactItem}>
                  ...
                  <a href={`tel:${identitas.telepon}`} className={styles.contactItemValueLink}>
                    {identitas.telepon}
                  </a>
                </div>
              )}
              {identitas?.whatsapp && (
                <div className={styles.contactItem}>
                  ...
                  <a
                    ...
                    className={styles.contactItemValueLink}
                  >
                    {identitas.whatsapp}
                  </a>
                </div>
              ...
              {identitas?.email && (
                <div className={styles.contactItem}>
                  ...
                  <a href={`mailto:${identitas.email}`} className={styles.contactItemValueLink}>
                    {identitas.email}
                  </a>
                </div>
              )}
