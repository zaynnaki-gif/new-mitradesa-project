-- ============================================================
-- MITRADESA: BASELINE MIGRATION - FRESH DATABASE TEST
-- Created: 2026-08-13
--
-- PURPOSE:
-- This is the ACTUAL migration SQL that creates the entire schema.
-- Run this ONLY on a FRESH/EMPTY database.
--
-- USAGE:
--   1. Create a new empty database on Supabase
--   2. Update DATABASE_URL to point to the new database
--   3. Run: npx prisma migrate deploy
--   4. Or run this SQL directly against the empty database
-- ============================================================
...
ALTER TABLE "kabupaten" ADD CONSTRAINT "kabupaten_provinsi_id_foreign" FOREIGN KEY ("provinsi_id") REFERENCES "provinsi"("id") ON UPDATE NO ACTION;
ALTER TABLE "kecamatan" ADD CONSTRAINT "kecamatan_kabupaten_id_foreign" FOREIGN KEY ("kabupaten_id") REFERENCES "kabupaten"("id") ON UPDATE NO ACTION;
ALTER TABLE "desa" ADD CONSTRAINT "desa_kecamatan_id_foreign" FOREIGN KEY ("kecamatan_id") REFERENCES "kecamatan"("id") ON UPDATE NO ACTION;
ALTER TABLE "identitas_desa" ADD CONSTRAINT "identitas_desa_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "account_role" ADD CONSTRAINT "account_role_account_id_foreign" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "account_role" ADD CONSTRAINT "account_role_role_id_foreign" FOREIGN KEY ("role_id") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "role_permission" ADD CONSTRAINT "role_permission_role_id_foreign" FOREIGN KEY ("role_id") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "role_permission" ADD CONSTRAINT "role_permission_permission_id_foreign" FOREIGN KEY ("permission_id") REFERENCES "permission"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "penduduk" ADD CONSTRAINT "penduduk_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON UPDATE NO ACTION;
ALTER TABLE "keluarga" ADD CONSTRAINT "keluarga_kepala_id_foreign" FOREIGN KEY ("kepala_id") REFERENCES "penduduk"("id") ON UPDATE NO ACTION;
ALTER TABLE "keluarga" ADD CONSTRAINT "keluarga_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON UPDATE NO ACTION;
ALTER TABLE "anggota_keluarga" ADD CONSTRAINT "anggota_keluarga_keluarga_id_foreign" FOREIGN KEY ("keluarga_id") REFERENCES "keluarga"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "anggota_keluarga" ADD CONSTRAINT "anggota_keluarga_penduduk_id_foreign" FOREIGN KEY ("penduduk_id") REFERENCES "penduduk"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "internal_session" ADD CONSTRAINT "internal_session_account_id_foreign" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "citizen_session" ADD CONSTRAINT "citizen_session_penduduk_id_foreign" FOREIGN KEY ("penduduk_id") REFERENCES "penduduk"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "citizen_verification" ADD CONSTRAINT "citizen_verification_penduduk_id_foreign" FOREIGN KEY ("penduduk_id") REFERENCES "penduduk"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "otp_challenge" ADD CONSTRAINT "otp_challenge_verification_id_foreign" FOREIGN KEY ("verification_id") REFERENCES "citizen_verification"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "perangkat_desa" ADD CONSTRAINT "perangkat_desa_penduduk_id_foreign" FOREIGN KEY ("penduduk_id") REFERENCES "penduduk"("id") ON UPDATE NO ACTION;
ALTER TABLE "perangkat_desa" ADD CONSTRAINT "perangkat_desa_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON UPDATE NO ACTION;
ALTER TABLE "perangkat_desa" ADD CONSTRAINT "perangkat_desa_account_id_foreign" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
ALTER TABLE "kategori" ADD CONSTRAINT "kategori_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON UPDATE NO ACTION;
ALTER TABLE "berita" ADD CONSTRAINT "berita_penulis_id_foreign" FOREIGN KEY ("penulis_id") REFERENCES "account"("id") ON UPDATE NO ACTION;
ALTER TABLE "berita" ADD CONSTRAINT "berita_kategori_id_foreign" FOREIGN KEY ("kategori_id") REFERENCES "kategori"("id") ON UPDATE NO ACTION;
ALTER TABLE "halaman" ADD CONSTRAINT "halaman_created_by_id_foreign" FOREIGN KEY ("created_by_id") REFERENCES "account"("id") ON UPDATE NO ACTION;
ALTER TABLE "halaman" ADD CONSTRAINT "halaman_desa_id_foreign" FOREIGN KEY ("desa_id") REFERENCES "desa"("id") ON UPDATE NO ACTION;
ALTER TABLE "media" ADD CONSTRAINT "media_uploaded_by_id_foreign" FOREIGN KEY ("uploaded_by_id") REFERENCES "account"("id") ON UPDATE NO ACTION;

-- ============================================================
-- VERIFICATION QUERY (run after migration)
-- ============================================================
-- SELECT 'Tables created: ' || COUNT(*) FROM pg_tables WHERE schemaname = 'public';
-- SELECT 'Enums created: ' || COUNT(*) FROM pg_type WHERE typtype = 'e';
